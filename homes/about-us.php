        ...
        <div class="header">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <ul class="nav-menu ">
                    ...
                    <li class="active"><a href="#">About Us<span class="submenu-indicator"></span></a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <p class="text-center m-5"> We are a prominant Real Estate & Construction Company since 2007 with
                        numerous successfully established apartments across many places in Guwahati. Over the course of
                        our journey, our have established a firm foothold in this industry. Our belief that
                        customer satisfaction is as important as our products and services, have helped our
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <p class="text-center m-5">
                        We provide wide range of services such as
                        business of Real Estate Developers, Builders, Contractors,
                        construction services for all kinds of Residential, Commercial and other structures
                        including business of all kinds of Civil & Electrical
                        construction for the purpose of making Roads,
                        Bridge, Dams, Dikes and other Civil Constructions etc. in the north-east India.
                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <p class="text-center m-5">
                        Our company is promoted by experienced technical person Er. Rupanjan Sarma, B. E. in Electrical
                        Engineering & Post Graduated Diploma in Instrumentation and Er. Ranjit Choudhury, B. Tech in
                        Production.
                    </p>
            ...
            <div class="row text-center">
                <div class="col-md-6 ">
                    <img src="../assets/img/man1.jpg" class="img-fluid rounded-circle sq">
                    <h5 class="mt-3">Er. Rupanjan Sarma</h5>
                    <p>Director</p>
                </div>
                <div class="col-md-6">
                    <img src="../assets/img/man2.jpg" class=" img-fluid rounded-circle sq">
                    <h5 class="mt-3">Er. Ranjit Choudhury</h5>
                    <p>Director</p>
